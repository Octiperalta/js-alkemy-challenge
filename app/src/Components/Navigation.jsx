...
function Navigation({ children }) {
  ...
  return (
    <div className='relative h-screen flex'>
      ...
      {/* sidebar */}
      <div
        className={`bg-gradient-to-t flex-shrink-0 from-indigo-600 via-indigo-700 to-indigo-800 w-64 text-indigo-100 font-poppins absolute z-20 md:relative md:translate-x-0 inset-y-0 left-0 transform  transition duration-200 ease-in-out ${
